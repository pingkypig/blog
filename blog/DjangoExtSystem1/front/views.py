...
def index(request):
    ...
    return render(request,'index_myself.html',{'resume':resume,
                                              'results':results,
                                              'articles':articles,
                                              'first':first},)
...
def list(request):
    ...
    articles = pg.page(page)
    return render(request,'list_myself.html',{'resume':resume,
                                              'results':results,
                                              'articles':articles,
                                              'articles1': articles1,
                                              'first':first},)
...
def infopic(request,id):
    ...
    return render(request, 'infopic_myself.html', {'resume': resume,
                                                    'results': results,
                                                    'article':article
                                                    })
...
def about(request):
    ...
    return render(request, 'about_myself.html',{'results':results})
